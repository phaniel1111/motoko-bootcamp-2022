...
actor {
  ...
  //dfx canister call day_2 decimal_to_bits '(100)' 
    ...
    //dfx canister call day_2 capitalize_text '("abcdef")' 
    ...
    //dfx canister call day_2 is_inside '("abcdef", 97)' 
    ...
    //dfx canister call day_2 trim_whitespace '(" abc  def ")' 
    ...
    //dfx canister call day_2 duplicated_character '("abc a def")' 
  ...
  //dfx canister call day_2 size_in_bytes '("abcdef")' 
