...
actor {
  ...
  private func swap(array : [var Nat], i: Nat, j: Nat) : [Nat] { 
    ...
    return Array.freeze(array);
      ...
      //dfx canister call day_3 test_swap '(vec { 1 ; 3 ; 0 }, 0 , 1)'
  ...
  //dfx canister call day_3 seven '(vec { 1 ; 3 ; 5 ; 2 ; 7 ; 2 })'
  //dfx canister call day_3 seven '(vec { 1 ; 3 ; 5 ; 2 ; 8 ; 2 })'
  ...
  //dfx canister call day_3 nat_opt_to_nat '(opt 4, 3)'
  //dfx canister call day_3 nat_opt_to_nat '(null, 3)'
  ...
  //dfx canister call day_3 day_of_the_week '(9)'
  //dfx canister call day_3 day_of_the_week '(5)'
  ...
  //dfx canister call day_3 populate_array '(vec { opt 1 ; opt 3 ; null ; opt 2 ; opt 7 ; opt 2 })'
  ...
  //dfx canister call day_3 sum_of_array '(vec { 1 ; 3 ; 5 ; 2 ; 7 ; 2 })'
  var sum = 0;
  ...
  //dfx canister call day_3 squared_array '(vec { 1 ; 3 ; 5 ; 2 ; 7 ; 2 })'
  ...
  //dfx canister call day_3 increase_by_index '(vec { 1 ; 1 ; 1 ; 1 ; 1 ; 1 })'
  var i = 0;
  ...
  func contains<A>(array: [A], a: A, f: (A,A) -> Bool): Bool {
    ...
    return false;
      ...
      //dfx canister call day_3 test_contains '(vec { 1 ; 3 ; 5 ; 2 ; 7 ; 2 }, )'
